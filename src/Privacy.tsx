...
const processors: Processor[] = [
  ...
  {
    name: "Formspree",
    role: "Processes the waitlist and enterprise-sales forms on the marketing site (the email address, company, team size, and any message you submit) and forwards them to Rada.",
    region: "United States. Form submissions are transmitted to and stored by Formspree under its own data-processing terms.",
  },
  {
    name: "PostHog",
    role: "Product analytics for opt-in, anonymous in-app usage events. Only collected after you grant telemetry consent; no prompts, code, or API keys are sent.",
    region: "European Union (PostHog EU region).",
  },
];
          ...
          <nav className="flex items-center justify-between gap-4">
            ...
            <div className="flex items-center gap-3">
              <a
                ...
                className="hidden text-sm text-zinc-400 no-underline transition hover:text-white sm:inline-flex"
              >
                Terms
              </a>
              <a
                href={routePath("landing")}
                className="inline-flex items-center justify-center rounded-full border border-[#333] bg-white/[0.03] px-4 py-2 text-sm font-medium text-zinc-100 no-underline transition hover:border-blue-500/30 hover:bg-blue-500/10"
              >
                Back to home
              </a>
            </div>
        ...
        <section className="mt-12">
          ...
          >
            ...
            <p className="mt-2 text-zinc-300">
              <strong className="text-white">Rada OÜ</strong> (registrikood
              111111111), a private limited company registered in the Republic
              of Estonia, registered office [REGISTERED OFFICE ADDRESS],
              Tallinn, Estonia, is the controller for personal data processed
              via the Service. Data-protection contact:{" "}
              <a
                href="mailto:privacy@userada.dev"
                className="text-blue-300 underline-offset-4 hover:underline"
              >
